...
%>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//E7N" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<script>
        ...
        $.ajax({
            ...
            success:function(result){
                for (var news of result) {
                    newshtml += "<li><span>[ "+news.TITLE+" ]</span><a href='https://www.baidu.com/'>"+news.CONTENT+"</a></li>";
                }
            }
        })
        ...
        $.ajax({
            ...
            success:function(result){
                for (var category2 of result) {
                    producthtmls+= "<div class='zj_l_c'>" + "<h2><a href='indexServlet?action=doty2&cname="+category2.NAME+"&carid="+category2.ID+"'>"+category2.NAME+"</a></h2>" ;productmenu3(category2.ID);
                    producthtmls+="</div>";
                }
            }
        })
    ...
    function shoppingrecord(){
        ...
        $.ajax({
            ...
            data:{action:"shoprecord",user:${sessionScope.user.id==null?"null":sessionScope.user.id},currentpage:currentpageshop},
            dataType:"json",
            success:function(result){
                totalPageshop = result.totalPage;
                for (var shopRecord of result.list) {
                    shoprecordhtml+="<li>"+
                        "<div class='img'><a href='BuyCar.jsp'><img src='"+shopRecord.FILENAME+"' width='58' height='58' /></a></div>"+
                    "<div class='name'><a href='BuyCar.jsp'>"+findname(shopRecord.PRODUCTID)+"</a></div>"+
