...
<script>
    ...
    function gowuchemethod() {
            ...
            success: function (result) {
                for (var product of result) {
                    ...
                    gouwuche += "<tr class='xdd'>\n" +
                        "            <td>\n" +
                        "            \t<a class='biaojibiaoji' href='catelist?action=pagetiao&idd="+product.ID+"'><div class=\"c_s_img\"><img src='" +product.FILENAME+"' width=\"73\" height=\"73\" />" +
                        "</div>\商品名称："+product.NAME+"<br/><span class='stockcl'>"+product.DESCRIPTION+"</span>"+
                        "</td>\n" +
                        "            <td align=\"center\" style=\"color:#ff4e00;\" class=\"sumsmall\">￥" + (product.price).toFixed(2) + "</td>\n" +
                        "            <td align=\"center\" class=\"jifen\">" + (product.price * 0.6).toFixed(2) + "R</td>\n" +
                        "            <td align=\"center\"><a onclick='javascript:deletefav("+product.ID+",this)'>删除收藏</a></td>\n" +
                        "          </tr>";
                }
            }
        })
        ...
        gouwuche += "<tr height=\"70\">\n" +
            ...
            "<a href=\"javascript:deleteallfav()\">清空收藏</a>"+
            "            </td>\n" +
            "          </tr>" +
            "<tr valign=\"top\" height=\"150\">\n" +
            "          \t<td colspan=\"6\" align=\"right\">\n" +
            "            \t<a href=\"CategoryList.jsp\"><img src=\"images/buy1.gif\" /></a>&nbsp; &nbsp; <span  class='addz'></span>\n" +
            "            </td>\n" +
            "          </tr>";
        $(".car_tab").html(gouwuche);
        $(".car_tab tr:even").addClass("car_tr");
    }
    function deletefav(productid,thi){
        $.ajax({
            async: false,
            type: "post",
            url: "favorite",
